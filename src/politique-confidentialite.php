...
?>
<title>KROM Esport - Politique de confidentialité</title>
...
<meta property="og:title" content="Politique de confidentialité du site KROM Esport">
<meta property="og:description" content="Veuillez prendre connaissance de notre politique de confidentialité du site KROM Esport.">
<meta name="description" content="Veuillez prendre connaissance de notre politique de confidentialité du site KROM Esport.">

    <main>
        <h2 class="h2_sous_nav_politique_confidentialite">Politique de confidentialité</h2>

        <p class="texte_mentions_legales">
            Le site web krom-esport.fr est détenu par KROM Esport, qui est un contrôleur de données de vos données personnelles.

            Nous avons adopté cette politique de confidentialité, qui détermine la manière dont nous traitons les informations collectées par krom-esport.fr, qui fournit également les raisons pour lesquelles nous devons collecter certaines données personnelles vous concernant. Par conséquent, vous devez lire cette politique de confidentialité avant d'utiliser le site web de krom-esport.fr.

            Nous prenons soin de vos données personnelles et nous nous engageons à en garantir la confidentialité et la sécurité.
        </p>


        <h3 class="sous_titre">Les informations personnelles que nous collectons</h3>

        <p class="texte_mentions_legales">
            Lorsque vous visitez le krom-esport.fr, nous recueillons automatiquement certaines informations sur votre appareil, notamment des informations sur votre navigateur web, votre adresse IP, votre fuseau horaire et certains des cookies installés sur votre appareil. En outre, lorsque vous naviguez sur le site, nous recueillons des informations sur les pages web ou les produits individuels que vous consultez, sur les sites web ou les termes de recherche qui vous ont renvoyé au site et sur la manière dont vous interagissez avec le site. Nous désignons ces informations collectées automatiquement par le terme "informations sur les appareils". En outre, nous pourrions collecter les données personnelles que vous nous fournissez (y compris, mais sans s'y limiter, le nom, le prénom, l'adresse, les informations de paiement, etc.) lors de l'inscription afin de pouvoir exécuter le contrat.
        </p>


        <h3 class="sous_titre">Pourquoi traitons-nous vos données ?</h3>
        ...
        <p class="texte_mentions_legales">
            Si vous souhaitez exercer ce droit, veuillez nous contacter via ce <a href="contact.php">formulaire</a> ou à l'adresse suivante : contact@krom-esport.fr.
            <br>
            <br>
        ...
        <h3 class="sous_titre">Liens vers d'autres sites web</h3>
        ...
        <h3 class="sous_titre">Sécurité de l'information</h3>
        ...
        <h3 class="sous_titre">Divulgation légale</h3>
