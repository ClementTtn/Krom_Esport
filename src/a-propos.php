...
<main>
    ...
    <p class="texte_info"><a class="chiffres_couleur">KROM Esport</a> est une équipe française de compétition automobile sur diverses simulations virtuelles.<br><br>
        ...
        Le travail et la cohésion d'équipe ont permis de faire une excellente performance dès la première course.
        En effet, on retrouve nos 3 prototypes sur le podium, ainsi que nos 2 GTs sur les deux plus hautes marches du podium dans leur catégorie. <br><br>

        Depuis, notre volonté de devenir un acteur important du Sim Racing français n'a <a class="chiffres_couleur">jamais faibli</a>. <br><br>

        Comptant sur l’expérience de leurs pilotes, KROM se développe constamment en s'appuyant sur ces 3 valeurs : <a class="chiffres_couleur">passion, performance, ambition</a>.<br><br>
    </p>

    <p class="texte_info">Au plaisir de vous croiser sur la grille de départ !</p>
